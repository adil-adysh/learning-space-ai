...
const NoteWrapperImport = () =>
	import("./__tests__/NoteModalTestWrapper.svelte");
...
test("creating a note focuses the newly-created note element", async () => {
	...
	const createdBtn = page.getByRole("button", {
		name: /Open note Created Title/i,
	});
